...
<ul> 
<li class="iheader">About Them</li> 
<li><label for="query">*Name/ID</label><textarea class="itext" name="query" id="query" /></textarea>
<br /><i>Split by line</i> 
<li class="iseparator">&nbsp;</li> 
<li><label>&nbsp;</label><input type="submit" onsubmit="return sendForm()" class="ibutton" name="Whatdoyouknowaboutme" id="Whatdoyouknowaboutme" value="Get information?" /></li> 
</ul></form> 
</body>
</html>
